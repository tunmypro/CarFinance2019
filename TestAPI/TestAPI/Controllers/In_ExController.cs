...
namespace TestAPI.Controllers
{
    public class In_ExController : ApiController
    {
        ...
        // GET: api/In_Ex
        public IHttpActionResult GetIn_Ex()
        {
            var sum = db.In_Ex;
            ...
            return Json(new {sumin = string.Format("{0,12:0,000.00}", sumin), sumex = string.Format("{0,12:0,000.00}", sumex),total  = string.Format("{0,12:0,000.00}", sumin - sumex) });
        }
